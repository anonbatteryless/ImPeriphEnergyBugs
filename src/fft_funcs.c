...
void fft(int mat_dim, mat_t *dest_real, mat_t *dest_imag, mat_t *inter_real,
			mat_t *inter_imag) {
  int16_t num_elements = MAT_SIZE;
...
// Takes a sensor function and pulls data into the right matrix
void fft_short_data(float (*sense)(),uint16_t sample_len) {
	static int i=0,j=0;
  BIT_FLIP(1,3);
  UNSAFE_ATOMIC_START;
