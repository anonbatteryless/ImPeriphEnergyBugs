...
void smv_mega_init(int mat_dim) {
...
void smv_mega(int mat_dim, mat_t *src, mat_t *dest, mat_t *filter) {
...
void smv_mega_check(int mat_dim) {
	printf("Done!\r\n");
#ifdef CONSOLE
...
void smv_mega_data(float (*sense)(),int mat_dim) {
  UNSAFE_ATOMIC_START;
...
void smv_mega_short_data(float (*sense)(),uint16_t sample_len, int mat_dim) {
	static uint16_t i = 0;
  //UNSAFE_ATOMIC_START;
